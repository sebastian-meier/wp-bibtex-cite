...
require_once( ABSPATH . 'wp-content/plugins/wp-bibtex-cite/includes/phpBibLib/lib_bibtex-printers.inc.php' );
require_once( ABSPATH . 'wp-content/plugins/wp-bibtex-cite/includes/phpBibLib/lib_bibtex-db.inc.php' );
...
class Bibtex {
	...
	function ParseFiles($files) {
		foreach($files as $file) {
			if(is_string($file)) {
				//!!!! For using temporary uploaded files
...
CITATION FUNCTIONS NEED TO BE MOVED TO THE PLUGIN-OBJECT...
